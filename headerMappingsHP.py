...
def makeAllHeaderMappings():
    lstHeaderMapping = {
        ...
        'Stream3 Flow':                 ['MV12' ,'V_gas_str3','m3(n)/h'],
        'Stream3 Pressure':             ['MV13' ,'p_uit_str3','bara'],
        'Stream3 Temperature':          ['MV14' ,'T_uit_str3','\u00b0C'],
        ...
        'Belimo01 FlowRate':         ['MV17','Vw_ket_1','l/h'], #For the Belimo values, the amount differs per location. Therefore, but the highest number is always WP, second highest is OV and lowest is ket_1, the rest we ignore
        'Belimo-2highest FlowRate':         ['MV20','Vw_ex_OV','l/h'], #For the Belimo values, the amount differs per location. Therefore, but the highest number is always WP, second highest is OV and lowest is ket_1, the rest we ignore
        'Belimo-highest FlowRate':         ['MV21','Vw_WP','l/h'], #For the Belimo values, the amount differs per location. Therefore, but the highest number is always WP, second highest is OV and lowest is ket_1, the rest we ignore
        'Belimo01 Temp1 external':      ['MV22','Tw_ket1_in','\u00b0C'], 
        'Belimo01 Temp2 internal':      ['MV23','Tw_ket1_uit','\u00b0C'],
        'Belimo-2highest Temp2 internal':      ['MV28','Tw_OV_uit','\u00b0C'],
        'Belimo-2highest Temp1 external':      ['MV29','Tw_OV_in','\u00b0C'],
        'ADAM PT1000 01':               ['MV30','Tb_1','\u00b0C'],
        'ADAM PT1000 02':               ['MV31','Tb_2','\u00b0C'],
        'ADAM PT1000 03':               ['MV32','Tb_3','\u00b0C'],
        'ADAM PT1000 04':               ['MV33','Tb_4','\u00b0C'],
        'Belimo-highest Temp1 external':      ['MV34','T_WP_in','\u00b0C'],
        'Belimo-highest Temp2 internal':      ['MV35','T_WP_uit','\u00b0C'],
